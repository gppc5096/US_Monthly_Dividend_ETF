...
- 앱 배포명 : https://us-monthly-dividend-etf--usmonthlydividendetf.asia-east1.hosted.app
...
| ----------- | --------- | ------------------------------------------------------------------------ |
| `--bg`      | `#0F1720` | 다크 기본 배경                                                                 |
| `--surface` | `#1C2836` | 카드 (P3 접근성 보정: 원안 `#18222E`는 배경과 대비가 1.2:1 수준이라 카드 경계가 거의 안 보였음 → 명도 상향) |
| `--ink`     | `#E8EDF2` | 본문                                                                       |
